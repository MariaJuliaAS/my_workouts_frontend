            ...
            <main className="w-full text-white flex justify-center h-full">
                {pr.length === 0 ? (
                    <div className="flex items-center justify-center flex-col">
                        ...
                        <p className="font-medium text-lg sm:text-xl">Nenhum PR ainda</p>
                        <p className="text-gray-400 max-w-68 text-center">Adicione seu primeiro PR e comece a acompanhar seu progresso</p>
                        <NavLink to="/pr/novo"
